const DICT = {
  es: {
    ...
    "menu.theme_config": "Config",
    "menu.data_saver": "Ahorro de datos",
    "menu.list_pane": "Panel listas",
    "menu.pane_right": "Derecha",
    "menu.pane_left": "Izquierda",
    "menu.pane_right_short": "Der",
    "menu.pane_left_short": "Izq",
    "menu.user": "Usuario",
  ...
  en: {
    ...
    "menu.theme_auto": "Auto",
    "menu.theme_config": "Config",
    "menu.data_saver": "Data saver",
    "menu.list_pane": "List pane",
    "menu.pane_right": "Right",
    "menu.pane_left": "Left",
    "menu.pane_right_short": "Right",
    "menu.pane_left_short": "Left",
    "menu.user": "User",
