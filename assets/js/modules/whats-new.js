...
const WHATS_NEW_BY_VERSION = {
  "v1.0.0": {
    es: [
      ...
      "Listado de canciones ajustado a 5 visibles para mejorar lectura en Car Unit.",
      "Avance automático del listado por bloques de 5 canciones (1-5, 6-10, 11-15...) en reproducción continua.",
      "Corrección de la barra de progreso y buffer al cambiar manualmente de canción desde la lista.",
      "Nuevo ajuste Ahorro de datos: transcodificación MP3 192 kbps para reducir consumo en conexiones móviles.",
      "Menú del player compactado: Tema (Config), Ahorro de datos, Panel listas, Idioma y Usuario.",
    ...
    en: [
      ...
      "Song list adjusted to 5 visible rows for better readability on Car Unit screens.",
      "Automatic queue scrolling now moves in 5-song blocks (1-5, 6-10, 11-15...) during continuous playback.",
      "Fixed progress and buffer bar rendering when manually changing tracks from the list.",
      "New Data Saver setting: MP3 192 kbps transcoding to reduce mobile data usage.",
      "Player menu compacted with quick controls: Theme (Config), Data Saver, List Pane, Language, and User.",
