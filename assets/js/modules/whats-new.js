...
const WHATS_NEW_BY_VERSION = {
  "v0.1.0-alpha.6": [
    ...
    "Favoritas arranca en modo aleatorio al pulsar.",
    "Mas reproducidas queda temporalmente oculta hasta corregir por completo su logica.",
    ...
    "Nueva pagina de debug (`debug.html`) para ver llamadas, respuestas, covers y eventos del reproductor.",
  ],
  "v0.1.0-alpha.5": [
